...
public class JSQDAO {
	public ArrayList<JSQDTO> JSQList(JSQDTO jcq1) {
		...
		jsqlist.add(new JSQDTO(jcq1.getQuest()));
...
//		문제 번호, 문제, 문제 정답
		jsqlist.add(new JSQDTO("이것은 컴퓨터 프로그램입니다."));
		jsqlist.add(new JSQDTO("이것은 획기적인 언어입니다."));
		jsqlist.add(new JSQDTO("이것은 이클립스와 비슷한 프로그램입니다."));
		System.out.println("===============================================\n");
