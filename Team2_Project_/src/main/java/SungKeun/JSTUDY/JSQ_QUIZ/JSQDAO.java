...
public class JSQDAO {
	public ArrayList<JSQDTO> JSQList(JSQDTO jcq1) {
		...
		jsqlist.add(new JSQDTO(jcq1.getQuestNum(), jcq1.getQuest(), jcq1.getAnswer()));
...
//		문제 번호, 문제, 문제 정답
		jsqlist.add(new JSQDTO(0, "이것은 컴퓨터 프로그램입니다.", "이클립스"));
		jsqlist.add(new JSQDTO(3, "이것은 획기적인 언어입니다.", "JAVA(자바)"));
		jsqlist.add(new JSQDTO(8, "이것은 이클립스와 비슷한 프로그램입니다.", "비주얼스튜디오코드(VSC)"));
		System.out.println("===============================================\n");
