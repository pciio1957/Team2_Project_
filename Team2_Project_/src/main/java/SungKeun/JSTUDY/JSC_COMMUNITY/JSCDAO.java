...
//		jsclist.add(new JSCDTO(6, "반갑습니다!", "홍시", "2021/06/26 22:08:22" ,"홈페이지 제작 처음입니다!"));
//		jsclist.add(new JSCDTO(5, "너무 좋은 사이트네요ㅎㅎ", "himan","2021/06/26 19:12:36", "저는 현직 개발자입니다!"));
//		jsclist.add(new JSCDTO(4, "ㅎㅇ", "cool","2021/06/26 19:08:17", "ㅎㅇㅎㅇ"));
//		jsclist.add(new JSCDTO(3, "여기는 뭐하는 곳이죠??", "byeman","2021/06/25 23:46:11", "처음이라 잘 부탁드려요..ㅎㅎㅎ"));
//		jsclist.add(new JSCDTO(2, "오 드디어 오픈이네요!", "강남살아요","2021/06/25 20:18:02", "배우러 왔습니다!"));
//		jsclist.add(new JSCDTO(1, "안녕하세요!", "홍길동","2021/06/25 17:11:53", "잘 부탁드려요~"));
//		System.out.println("===============================================\n");
//		
//		return jsclist;
//	}
	...
	public ArrayList<JSCDTO> JSCFList(JSCDTO jcof1) {
		...
		System.out.println("===============================================\n");
		System.out.println("# DB 서버에서 온 자유 게시판 게시물 정보 데이터 리스트 #\n");
		// 게시물 번호, 제목, 작성자, 작성일, 작성 내용
	...
	public ArrayList<JSCDTO> JSCSList(JSCDTO jcos1) {
	    ...
	    // 전체 게시물 입력 데이터를 확인하기 위한 메소드
		System.out.println("===============================================\n");
		System.out.println("# DB 서버에 넘겨 줄 스터디 게시물 정보 데이터 #\n");
		...
		System.out.println("===============================================\n");
		System.out.println("# DB 서버에서 온 스터디 게시물 정보 데이터 리스트 #\n");
		// 게시물 번호, 제목, 작성자, 작성일, 작성 내용
	...
	public ArrayList<JSCDTO> JSCQList(JSCDTO jcoq1) {
	    ...
	    // 전체 게시물 입력 데이터를 확인하기 위한 메소드
		System.out.println("===============================================\n");
		System.out.println("# DB 서버에 넘겨 줄 질문 답변 게시물 정보 데이터 #\n");
		System.out.println("질문 답변 게시물 번호 : " + jcoq1.getWriteNum() + "\n");
		System.out.println("질문 답변 게시물 제목 : " + jcoq1.getHeadLine() + "\n");
		System.out.println("질문 답변 게시물 작성자 : " + jcoq1.getWriter() + "\n");
		System.out.println("질문 답변 게시물 작성일 : " + jcoq1.getWriteDate() + "\n");
		System.out.println("질문 답변 게시물 작성 내용 : " + jcoq1.getWrite() + "\n");
		System.out.println("===============================================\n");
		System.out.println("# DB 서버에서 온 질문 답변 게시물 정보 데이터 리스트 #\n");
		// 게시물 번호, 제목, 작성자, 작성일, 작성 내용
